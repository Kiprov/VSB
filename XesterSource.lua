...
sp.Name = "ShakePower"
local camShake = NLS([[
local cg = script.Parent
local power = Instance.new("NumberValue")

cg.ScreenShake.Changed:Connect(function()
	if cg.ScreenShake.Value then
		game:GetService("TweenService"):Create(power,TweenInfo.new(0),{Value=cg.ScreenShake.ShakePower.Value}):Play()
	else
		game:GetService("TweenService"):Create(power,TweenInfo.new(2),{Value=cg.ScreenShake.IdlePower.Value}):Play()
	end
end)
cg.ScreenShake.ShakePower.Changed:Connect(function()
	if cg.ScreenShake.Value then
		game:GetService("TweenService"):Create(power,TweenInfo.new(0),{Value=cg.ScreenShake.ShakePower.Value}):Play()
	else
		game:GetService("TweenService"):Create(power,TweenInfo.new(2),{Value=cg.ScreenShake.IdlePower.Value}):Play()
...
cg.ScreenShake.IdlePower.Changed:Connect(function()
	if cg.ScreenShake.Value then
		game:GetService("TweenService"):Create(power,TweenInfo.new(0),{Value=cg.ScreenShake.ShakePower.Value}):Play()
	else
		game:GetService("TweenService"):Create(power,TweenInfo.new(2),{Value=cg.ScreenShake.IdlePower.Value}):Play()
...
print("Initiated cam shake client.")
...
doomtheme.SoundId = "rbxassetid://1843402863"
doomtheme:Play()
