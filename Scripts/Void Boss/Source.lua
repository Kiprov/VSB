...
ZTfade=false 
ZT=false
musiclist = {18841894272,18841887539,1842652230,9046451355,1845821031,9042493127,9038254566,1838626744,1837434037,1837293686,9038253134,1837278123,9038251495,1837307893,1845793864,9038254146,1838075377}
...
local crying = "http://www.roblox.com/asset/?id=468911141"
...
function Attack1()
	...
	if mememode == false then
		...
		WACKYEFFECT({Time = 100, EffectType = "Sphere", Size = VT(0,0,0), Size2 = VT(600,600,600), Transparency = 0, Transparency2 = 1, CFrame=RootPart.CFrame, MoveToPos = nil, RotationX = 0, RotationY = 0, RotationZ = 0, Material = "Neon", Color = C3(0,0,0), SoundID = 170755561, SoundPitch = 1.5, SoundVolume = 10})
		...
		WACKYEFFECT({Time = 100*2, EffectType = "Sphere", Size = VT(0,0,0), Size2 = VT(1600,1600,1600), Transparency = 0, Transparency2 = 1, CFrame=RootPart.CFrame, MoveToPos = nil, RotationX = 0, RotationY = 0, RotationZ = 0, Material = "Neon", Color = C3(0,0,0), SoundID = 170755561, SoundPitch = 0.72, SoundVolume = 10})
		for i = 10, 60,10 do
...
CurId = CurId + 0.5
		lastid= "http://www.roblox.com/asset/?id="..musiclist[math.random(1,#musiclist)] --1847367023 194920243 207702489
		...
		coroutine.resume(coroutine.create(function()
			...
			if s2.Parent == nil or s2 == nil  then
				...
				if mememode == false then
					...
					--[[if (not s2:FindFirstChild("DISTORTION") or not s2:FindFirstChild("EQUALIZER") or not s2:FindFirstChild("ECHO")) and CurId ~= 1.5 then
						local dist = it("DistortionSoundEffect",s2)
						local equal = it("EqualizerSoundEffect",s2)
						local echo = it("EchoSoundEffect",s2)
						dist.Name = "DISTORTION"
						equal.Name = "EQUALIZER"
						echo.Name = "ECHO"
						dist.Level = .5
						echo.Delay = 0.1
						echo.DryLevel = 3
