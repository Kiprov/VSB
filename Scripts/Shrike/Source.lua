...
* = Requires to have sidekick equipped.
All attacks become stronger in phase 2.
----------------------------------------------------
Q - Teleport
E - Ground Smash
R - Dice Roll
...
local dmt2 = {1843002153,1837853076,1842948977,1837029543}
...
local secondtheme={85798809188497,101859927544989,130823491893656,1837278308}
