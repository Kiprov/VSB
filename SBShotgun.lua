...
ToolName = "Weapon" 
Icon = Asset..(58334502)
FC = script:FindFirstChild("FixCam"):Clone()
function ReNew() 
	if EffectModel then 
...
function Reload(once) 
	...
	wait(0.5)
	if Ammunition.Ammo >= 500 and Selected and not Attacking and Ammunition.Ammoleft > 0 then
		local ClipIn = Instance.new("Sound",Torso)
		ClipIn.Name = "ClipIn"
		ClipIn.SoundId = Sounds.Fire.Id
		ClipIn.Volume = Sounds.Fire.Volume
		ClipIn.Pitch = Sounds.Fire.Pitch
		ClipIn.TimePosition = 0.45
		ClipIn:Play()
